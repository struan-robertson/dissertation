...
Traditional algorithmic methods for correcting no-data voids within DEMs include inverse distance weight method (IDW), local polynomial interpolation method (LPI), spline with tension method (ST) and other algorithms to interpolate the elevation sampling points. Interpolation methods use the neighbouring elevation values for void infilling, thus performance is directly proportional to the size of the void. Voids of any significant size result in interpolation methods returning inaccurate reconstruction results.  \autocite{reuterEvaluationVoidFilling2007}

Image inpainting:
\begin{itemize}
\item Self supervised wasserstein GAN
\item Very successful with images
\item DEMs are very similar to images
\item This is what is implemented in this paper
\item Post-processing steps
\end{itemize}

The problem of image inpainting within the field of computer vision fundamentally attempts to solve the same problem as DEM void infilling; DEMs are a 2 dimensional grid of elevation values, which can be thought of as the pixels in a greyscale images.
Deep learning generational models have been shown to have excellent performance in image inpainting\autocite{pathakContextEncodersFeature2016,yuGenerativeImageInpainting2018} and have been successfully applied to DEM void infilling\autocite{gavriilVoidFillingDigital2019,zhangVoidFillingBased2020,qiuVoidFillingDigital2019}

\section{Background}
\label{sec:org31beb77}

\section{Specification}
\label{sec:org752bf7a}

\section{Design}
\label{sec:orgc4aca7b}

\section{Implementation and Testing}
\label{sec:orgb791c77}

\section{Evaluation / Testing}
\label{sec:org3bcf2d5}

\section{Description of the final product}
\label{sec:org1714e1b}

\section{Appraisal}
\label{sec:org479c52f}

\section{Summary and Conclusions}
\label{sec:orgdf659e2}

\section{Future Work}
\label{sec:org29e0537}
