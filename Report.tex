...
\section{Background}
\label{sec:org09b0cb5}
\subsection{Digital Elevation Maps}
\label{sec:orga4e2185}
...
\label{sec:org26e1c0e}

\subsubsection{Generative Adversarial Networks}
\label{sec:orgc47db98}

\subsection{Poisson Blending}
\label{sec:org1ca822d}
...
\label{sec:orge600013}

\section{Design}
\label{sec:org797f174}

\section{Implementation and Testing}
\label{sec:org0fe318e}

\section{Evaluation / Testing}
\label{sec:orgc1bae6c}

\section{Description of the final product}
\label{sec:org262eb7f}

\section{Appraisal}
\label{sec:org3f4441f}

\section{Summary and Conclusions}
\label{sec:orgd6585ad}

\section{Future Work}
\label{sec:orgfce9071}
