...
\section{Background}
\label{sec:org4eb31e7}
\subsection{Digital Elevation Maps}
\label{sec:orgb3d99cb}
...
\label{sec:orgf275b60}
\subsection{Data Post-processing}
\label{sec:orga495487}
\subsubsection{Poisson Blending}
\label{sec:org1aa2ece}
...
\label{sec:orga052bc4}


\section{Experiments}
\label{sec:orga4ce8a6}
\subsection{Model Training}
\label{sec:orgbd603fd}
Talk about all the changes made to the network
\subsection{Model Testing Methodology}
\label{sec:org26be3de}


\section{Results}
\label{sec:org76c1a2c}
...
\section{Discussion}
\label{sec:orgaca5578}

\section{Conclusion}
\label{sec:org9af929f}

\section{Future Work}
\label{sec:org8e4a054}
