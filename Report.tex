...
\section{Background}
\label{sec:org6b529cc}
\subsection{Digital Elevation Maps}
\label{sec:orgcce7958}
...
We refer to pixels \(p\) for which \(m_p = 0\) as \emph{known}, and \emph{unknown} otherwise.
...
\label{sec:org596cee7}
\subsection{Data Post-processing}
\label{sec:org32404be}
\subsubsection{Poisson Blending}
\label{sec:orgadb1567}
...
\label{sec:org7278914}


\section{Experiments}
\label{sec:org01728c7}
\subsection{Model Training}
\label{sec:org438f2ae}
Talk about all the changes made to the network
\subsection{Model Testing Methodology}
\label{sec:org4337d11}


\section{Results}
\label{sec:org8c5b4ee}
...
\section{Discussion}
\label{sec:orgc81d601}

\section{Conclusion}
\label{sec:orgef7b508}

\section{Future Work}
\label{sec:orgcc18560}
