...
\section{Background}
\label{sec:org20df199}
\subsection{Digital Elevation Maps}
\label{sec:org3dd3ec2}
...
\label{sec:orgca4f7f0}


\section{Experiments}
\label{sec:org44b292e}
\subsection{Model Training}
\label{sec:orgbc1c08f}
Talk about all the changes made to the network
\subsection{Model Testing Methodology}
\label{sec:org421a83f}

\section{Results}
\label{sec:orgfc87e00}
...
\section{Discussion}
\label{sec:orga98866e}

\section{Conclusion}
\label{sec:org8ae04d9}

\section{Future Work}
\label{sec:org2efe131}
