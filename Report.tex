...
This project aims to use a machine learning model to allow for the technique of image inpainting to be used with lunar DEMs.
...
A Generative Adversarial Network (GAN) based on a fully convolutional architecture will be used for the inpainting.

\end{abstract}

\section{Introduction}
\label{sec:org3234048}
