...
\section{Background}
\label{sec:org2c34d25}
\subsection{Digital Elevation Maps}
\label{sec:org30b4795}
...
\label{sec:orgde71e95}


\section{Experiments}
\label{sec:org29cf14d}
\subsection{Model Training}
\label{sec:org158b257}
Talk about all the changes made to the network
\subsection{Model Testing Methodology}
\label{sec:org204c4b7}


\section{Results}
\label{sec:org6928c93}
...
\section{Discussion}
\label{sec:org1adc1d8}

\section{Conclusion}
\label{sec:orgaf564bf}

\section{Future Work}
\label{sec:orgef4da1c}
