...
\section{Background}
\label{sec:orgc5242f1}
\subsection{Digital Elevation Maps}
\label{sec:orgf23857d}
...
Steepness in this context is a measure of the change in elevation over a given distance.
...
\label{sec:org240adba}

\section{Design}
\label{sec:org7f306ee}

\section{Implementation and Testing}
\label{sec:orge1dd855}

\section{Evaluation / Testing}
\label{sec:orgbb1e15a}
...
\label{sec:org5b07dbb}

\section{Appraisal}
\label{sec:orge2eb2fe}

\section{Summary and Conclusions}
\label{sec:org1616b0b}

\section{Future Work}
\label{sec:orgdda5786}
