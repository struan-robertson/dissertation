...
\section{Background}
\label{sec:org2cb02b8}
\subsection{Digital Elevation Maps}
\label{sec:orgeb86bd2}
...
\label{sec:orgaab03ae}


\section{Experiments}
\label{sec:orgfd5a03b}
\subsection{Model Training}
\label{sec:orgce5d545}
Talk about all the changes made to the network
\subsection{Model Testing Methodology}
\label{sec:orgdc04437}


\section{Results}
\label{sec:org6318aa4}
...
\section{Discussion}
\label{sec:org02c4c47}

\section{Conclusion}
\label{sec:org61a2526}

\section{Future Work}
\label{sec:org291e078}
