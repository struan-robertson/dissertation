...
\section{Background}
\label{sec:orga1501de}
\subsection{Digital Elevation Maps}
\label{sec:org184ddb7}
...
\label{sec:org10dd9c2}


\section{Experiments}
\label{sec:orgfd2243b}
\subsection{Model Training}
\label{sec:org0ab24b0}
Talk about all the changes made to the network
\subsection{Model Testing Methodology}
\label{sec:org78b96c6}


\section{Results}
\label{sec:orge96b853}
...
\section{Discussion}
\label{sec:org481fca1}

\section{Conclusion}
\label{sec:org2798c98}

\section{Future Work}
\label{sec:orgce6c18c}
