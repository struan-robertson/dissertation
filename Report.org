...
*** Deep Generational Model Discriminant Loss
...
Yu /et al./[cite:@yuGenerativeImageInpainting2018] implemented this with multiplication of gradients and input mask $m$:
\begin{equation}
\begin{split}
