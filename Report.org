...
[cite:@gavriilVoidFillingDigital2019]

In /DEM Void Filling Based on Context Attention Generation Model/ by Zhang /et al./[cite:@zhangVoidFillingBased2020] they make the argument that the use of local feature extraction by Gavriil /et al./[cite:@gavriilVoidFillingDigital2019] has a negative impact on the networks ability to recover overall DEM semantic information.
As both Zhang /et al./ and Gavrill /et al./ base their network structure on the inpainting GAN descrribed by Yu /et al./[cite:@yuGenerativeImageInpainting2018], this difference in opinion results in  
